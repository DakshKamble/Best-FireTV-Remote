...
typedef uint8_t MediaKeyReport[3]; // Extended to 3 bytes to accommodate more media keys
...
const MediaKeyReport KEY_MEDIA_LOCAL_MACHINE_BROWSER = {0, 1, 0}; // Opens "My Computer" on Windows
...
const MediaKeyReport KEY_MEDIA_CONSUMER_CONTROL_CONFIGURATION = {0, 64, 0}; // Media Selection
const MediaKeyReport KEY_MEDIA_EMAIL_READER = {0, 128, 0};
const MediaKeyReport KEY_MEDIA_FAST_FORWARD = {0, 0, 1}; // Fast Forward for Fire TV (bit 0 of third byte)
const MediaKeyReport KEY_MEDIA_REWIND = {0, 0, 2}; // Rewind for Fire TV (bit 1 of third byte)
